...
export default function Ctatop() {
    return (
        <div className="flex justify-center items-center px-4 py-0 mt-4 md:py-14 mb-1 md:-mt-10 lg:mt-4 xl:mt-10">
            <div className="text-center 2xl:max-w-screen-2xl">
                ...
                <div>
                    <a href="#"><button type='button' className="z-10 cursor-pointer bg-orange hover:bg-horange py-4 px-2 rounded-md text-white text-ft font-pp font-extra-bold tracking-wide mt-6 relative md:px-16 md:py-4">Quero conhecer a plataforma</button></a>
                </div>
