    ...
    return (
        <div className="flex justify-center items-center px-4 py-14">
            <div className="md:text-center">
                ...
                <div className="mt-5 md:hidden"><span className="text-gray">*Teste gratuito por 7 dias. Não solicitamos cartão de crédito.</span></div>
                <div className="transform rotate-90 mt-5 mr-0 md:rotate-0 md:-mt-32 md:-mr-48"><Image src="/images/seta.svg" width={167} height={134} /></div>
                </div>
