...
export default function Ctafooter() {
    return (
        <div className="flex justify-center items-center py-14 px-4 text-left">
            <div className="text-center">
                    <h3 className="text-blue font-mt font-bold text-tth1 mb-4 text-left">Conheça e experimente a nossa plataforma,<br/><span className="text-orange">sem pagar nada</span> por isso!</h3>
