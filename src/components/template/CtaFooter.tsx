        ...
        <div className="flex justify-center items-center pt-20 pb-40 px-4 text-left">
            <div className="text-center">
                ...
                <div className="md:inline-block md:text-right"> 
                    <div>
                        <a href="https://maestrus.com/teste-gratis/?frm=2"><button className="z-10 cursor-pointer bg-orange hover:bg-horange py-4 px-2 rounded-md text-white text-ft font-pp font-extra-bold tracking-wide mt-6 relative md:px-16 md:py-4">Quero Experimentar a Plataforma</button></a>    
                    </div>
