...
export default function Cardfour() {
    return (
        <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-9 lg:mt-12 lg:mb-12 2xl:px-0">
            <h2 className="text-blue font-mt font-bold text-tth1 mb-16 text-justify">Veja empresas que já estão utilizando a plataforma em seu ambiente corporativo</h2>
